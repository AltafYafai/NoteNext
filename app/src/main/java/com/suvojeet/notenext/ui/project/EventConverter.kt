...
fun NotesEvent.toProjectNotesEvent(): ProjectNotesEvent {
    return when (this) {
        ...
        is NotesEvent.OnReminderChange -> throw IllegalArgumentException("OnReminderChange event cannot be converted")
        ...
        is NotesEvent.CreateNoteFromQr -> throw IllegalArgumentException("CreateNoteFromQr event cannot be converted")
